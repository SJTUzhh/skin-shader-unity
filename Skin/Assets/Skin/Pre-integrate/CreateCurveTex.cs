...
{
    [MenuItem("Tools/Pre-Integrate/CreateCurveTex")]
    static void DoIt()
    {
        Mesh mesh;
        Material mat;
        ...
        mat.shader = Shader.Find("Skin/Pre-Integrate_SkinBake");
        mat.SetPass(0);
        ...
        result.Apply();
        System.IO.File.WriteAllBytes("Assets/Skin/Pre-integrate/curve.png", result.EncodeToPNG());
